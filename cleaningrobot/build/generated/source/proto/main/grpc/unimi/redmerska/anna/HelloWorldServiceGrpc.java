...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<unimi.redmerska.anna.Hello.HelloRequest,
      unimi.redmerska.anna.Hello.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = unimi.redmerska.anna.Hello.HelloRequest.class,
      responseType = unimi.redmerska.anna.Hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<unimi.redmerska.anna.Hello.HelloRequest,
      unimi.redmerska.anna.Hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<unimi.redmerska.anna.Hello.HelloRequest, unimi.redmerska.anna.Hello.HelloResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<unimi.redmerska.anna.Hello.HelloRequest, unimi.redmerska.anna.Hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  unimi.redmerska.anna.Hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  unimi.redmerska.anna.Hello.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(unimi.redmerska.anna.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<unimi.redmerska.anna.Hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void hello(unimi.redmerska.anna.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<unimi.redmerska.anna.Hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public unimi.redmerska.anna.Hello.HelloResponse hello(unimi.redmerska.anna.Hello.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<unimi.redmerska.anna.Hello.HelloResponse> hello(
        unimi.redmerska.anna.Hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((unimi.redmerska.anna.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<unimi.redmerska.anna.Hello.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              unimi.redmerska.anna.Hello.HelloRequest,
              unimi.redmerska.anna.Hello.HelloResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return unimi.redmerska.anna.Hello.getDescriptor();
    }
